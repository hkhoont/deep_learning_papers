...
**[2]** “**BackPropagation Through Time**.” [[pdf]](http://ir.hit.edu.cn/~jguo/docs/notes/bptt.pdf) 

**[3]** “**Multi-Dimensional Recurrent Neural Networks**” Useful when you want to understand what happens to image when you apply Multidirectional RNN. [[pdf]](https://arxiv.org/pdf/0705.2011.pdf)

**[4]** “**Training RNN**” Ilya Sutskever: A thesis submitted in conformity with the requirements for the degree of Doctor of Philosophy Graduate Department of Computer Science University of Toronto
 [[pdf]](http://www.cs.utoronto.ca/~ilya/pubs/ilya_sutskever_phd_thesis.pdf)
 
 **[5]** “**Learning long term dependency with gradient descent in RNN is difficult**”
 [[pdf]]( http://ai.dinfo.unifi.it/paolo//ps/tnn-94-gradient.pdf)
 
  **[6]** “**Deriving Back Propagation on simple RNN/LSTM**”
  ...
  **[6]** Razvan Pascanu, Caglar Gulcehre, Kyunghyun Cho, Yoshua Bengio “**How to Construct Deep Recurrent Neural Networks**”
[[pdf]](https://arxiv.org/pdf/1312.6026.pdf)

### 4.3 LSTM

**[7]** “**LSTM**.” This paper gives a mathematical  understanding of vanishing gradient problem in RNN and subsequent solution by developing LSTM [[pdf]](https://www.bioinf.jku.at/publications/older/2604.pdf)

**[8]** Tolga Bolukbasi, Kai-Wei Chang, James Zou, Venkatesh Saligrama, Adam Kalai “**Man is to Computer Programmer as Woman is to Homemaker? Debiasing Word Embeddings**.” Removing Bias in word embeddings [[pdf]](https://papers.nips.cc/paper/6228-man-is-to-computer-programmer-as-woman-is-to-homemaker-debiasing-word-embeddings.pdf)

### 4.4 RNN/LSTM Applications

**[9]** Elman Mansimov, Emilio Parisotto, Jimmy Lei Ba, Ruslan Salakhutdinov “**Generating Images from Captions with Attention**.” a model that generates images from natural language descriptions. [[pdf]](https://arxiv.org/pdf/1511.02793.pdf)

**[11]** Jimmy Ba, Geoffrey Hinton, Volodymyr Mnih, Joel Z. Leibo, Catalin Ionescu “**Using Fast Weights to Attend to the Recent Past**.” [[pdf]](https://arxiv.org/pdf/1610.06258.pdf)
